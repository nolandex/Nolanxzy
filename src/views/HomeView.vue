<template>
  <main
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://drive.google.com/file/d/1-ov_TuTSGtUwTUjYgMnN3YH-lbjre7aW/view?usp=drivesdk">
    </div>
  </main>
</template>
